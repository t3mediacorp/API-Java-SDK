...
public class GameState {
	...
	public void renderGame() {
		...
		System.out.println("  -------");
		System.out.println("0 |" + board[0][0].getDisplayValue() + "|" + board[0][1].getDisplayValue() + "|" + board[0][2].getDisplayValue() + "|");
		System.out.println("  -------");
		System.out.println("1 |" + board[1][0].getDisplayValue() + "|" + board[1][1].getDisplayValue() + "|" + board[1][2].getDisplayValue() + "|");
		System.out.println("  -------");
		System.out.println("2 |" + board[2][0].getDisplayValue() + "|" + board[2][1].getDisplayValue() + "|" + board[2][2].getDisplayValue() + "|");
		System.out.println("  -------");
	}
